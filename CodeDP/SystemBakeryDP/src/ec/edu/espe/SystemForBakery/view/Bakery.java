...
public class Bakery {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (option) {
                case 1 -> manageProduct(scanner, products);
                case 2 -> manageSuppliers(scanner, suppliers);
                case 3 -> manageOutputProducts(products);
                case 4 -> createOrder(scanner, products);
                case 5 -> {
    ...
    private static void manageProduct(Scanner scanner, List<Product> products) {
        ...
        float price = (float) Double.parseDouble(scanner.next());
        ...
        JsonGenerator.generateProductJson(product);
