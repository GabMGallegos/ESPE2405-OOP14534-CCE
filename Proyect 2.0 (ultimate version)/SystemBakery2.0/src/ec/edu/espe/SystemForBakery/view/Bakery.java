...
public class Bakery {
    ...
    public void displayMenu() {
        ...
        while (true) {
            ...
            System.out.println();
<<<<<<< HEAD:2.0/SystemBakery2.0/src/ec/edu/espe/SystemForBakery/view/Bakery.java
        } 
    }    
=======
        }
...
>>>>>>> 8e543469b9391b3f5f21d85d92d19b5a6dd71f05:Proyect 2.0 (ultimate version)/SystemBakery2.0/src/ec/edu/espe/SystemForBakery/view/Bakery.java
    private static void manageProduct(Scanner scanner, Stock stock) {
        ...
        BigDecimal priceBigDecimal = BigDecimal.valueOf(price); // Convert price to BigDecimal
...
>>>>>>> 8e543469b9391b3f5f21d85d92d19b5a6dd71f05:Proyect 2.0 (ultimate version)/SystemBakery2.0/src/ec/edu/espe/SystemForBakery/view/Bakery.java
    ...
    private static void createOrder(Scanner scanner, Stock stock) {
        ...
        BigDecimal totalOrderPrice = BigDecimal.ZERO; // Initialize totalOrderPrice as BigDecimal
        ...
        while (true) {
            ...
            totalOrderPrice = totalOrderPrice.add(totalPrice); // Perform addition with add()
        ...
        Bills bill = new Bills(billNumber, "Consumer Name", LocalDateTime.now()); // Adjust constructor call
    ...
    private static void manageBills(Scanner scanner, Stock stock) {
        ...
        // Add products to the bill (for simplicity, adding all products in stock)
