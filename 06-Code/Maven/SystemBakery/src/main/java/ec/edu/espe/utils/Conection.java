...
public class Conection {
    ...
    private String connectionString = "mongodb+srv://gagamol25:molina@clusterpractice.n0hps9y.mongodb.net/?appName=ClusterPractice";
    ...
    public Conection createConection() {
        try {
            ...
            mongoDatabase = mongoClient.getDatabase("BakeryDB");
            JOptionPane.showMessageDialog(null, "Conection succesfully");
